...
//       to,
//       subject: '¡Bienvenido a FitManager!',
//       template: 'welcome',
//       context: { name },
//     });
...
async sendWelcomeEmail(to: string, name: string) {
    await this.mailerService.sendMail({
      ...
      from: 'soporte@fitmanager.com',
      replyTo: 'contacto@fitmanager.com',
      text: `Hola ${name},  
        
      ¡Bienvenido a FitManager! Estamos muy contentos de que te hayas unido a nuestra comunidad.  
  
      - Accede a tu cuenta: https://fitmanager.com/login  
      - Explora nuestras funcionalidades: https://fitmanager.com/features  
...
//       to,
//       subject: 'Bienvenido a FitManager, ' + name + ' 🎉',
//       from: 'soporte@fitmanager.com', // Asegúrate de que este email esté autenticado en Brevo
//       replyTo: 'contacto@fitmanager.com',
//       text: `Hola ${name},  
